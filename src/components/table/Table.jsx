...
const Table = props => {
	...
	const watchResizeWindow = () => {
		...
		const colWidth = document.getElementsByClassName('header')[0].children[1].offsetWidth
	...
	return (
		<div className='table_wrapper'>
			...
			<h2>
				Width: {props.flexTable.width} Height: {props.flexTable.height} ColWidth:{' '}
				{props.flexTable.colWidth}
			</h2>
		</div>
	)
}
...
const mapDispatch = dispatch => ({
	setWidthAndHeight: payload => dispatch({ type: 'SET_WIDTH_AND_HEIGHT', payload }),
